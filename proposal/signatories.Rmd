...
Design and implementations in all three packages will be carried out by [Edzer Pebesma](https://github.com/edzer) and [Benedikt Gräler](https://github.com/bengraeler). Both are maintainer/contributor of the adressed packages and  `spacetime`, the predecessor of `sftime`. We will make discussions, design choices and implementations publicly available, but will i.e. discuss the development in the course of the project with ?? Roger ?? Robert ?? ... ??
